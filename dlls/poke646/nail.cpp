...
void CNail::NailTouch(CBaseEntity *pOther)
{
	...
	if (pOther->pev->takedamage)
	{
		...
		pOther->TraceAttack(pevOwner, gSkillData.plrDmg9MM, pev->velocity.Normalize(), &tr, DMG_NEVERGIB);
	...
	else
	{
		...
		if (contents != CONTENTS_WATER && contents != CONTENTS_SKY && RANDOM_LONG(0,5) == 0)
		{
